...
.colorgraph {
 ...
 Flat No :       <form:input class="form-control" path="flatNo" placeholder="flatNo" /> 
 				<form:errors path ="flatNo"/><br><br>
 Building Name: <form:input type="text" class="form-control" path="buildingName" placeholder="buildingName" />
                 <form:errors path ="buildingName"/><br><br>
 ...
 Pincode:        <form:input  class="form-control" path="pincode" placeholder="pincode"  />
                <form:errors path ="pincode"/><br><br>
